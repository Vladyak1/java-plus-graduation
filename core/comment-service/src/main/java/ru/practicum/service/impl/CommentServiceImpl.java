...
import ru.practicum.dto.CommentDtoPublic;
import ru.practicum.dto.CommentMapper;
...
public class CommentServiceImpl implements CommentService {
    ...
    public List<CommentDto> getAllCommentsByEvent(Long eventId) {
        EventFullDto event = eventService.getEventById(eventId);
        if (event.getState().equals(EventState.PUBLISHED.toString())) {
            List<Comment> comments = commentRepository.findAllByEventIdOrderByEventId(event);
