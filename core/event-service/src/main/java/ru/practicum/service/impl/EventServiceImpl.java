...
import ru.practicum.model.enums.StateActionForAdmin;
import ru.practicum.model.enums.StateActionForUser;
...
public class EventServiceImpl implements EventService {
    ...
    public List<EventShortDto> getAllEventOfUser(Long userId, Integer from, Integer size) {
        ...
        List<Event> events = eventRepository.findByInitiatorOrderByIdDesc(userId, PageRequest.of(from / size, size));
    ...
    public EventLongDto updateEventByUser(Long userId, Long eventId, UpdateEventUserRequest updateEvent) {
        ...
        if (updateEvent.getEventDate() != null) {
            if ((updateEvent.getEventDate()
                ...
                eventSaved.setEventDate(updateEvent.getEventDate());
            }
        }
    ...
    public EventLongDto updateEventByAdmin(Long eventId, UpdateEventAdminRequest updateEvent) {
        ...
        if (updateEvent.getEventDate() != null) {
            updateEventData(String.valueOf(updateEvent.getEventDate()), eventSaved);
        }
        if (updateEvent.getStateAction() != null) {
